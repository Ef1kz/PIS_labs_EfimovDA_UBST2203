...
SECRET_KEY = 'django-insecure-tt$q9jrakdf#6s5!q3@911-h1@@c01-=+oiy4e$$*0(9u=%we&'
...
INSTALLED_APPS = [
    ...
    'flatpages', #Добавляю созданное приложение flatpages
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db_firstwebpage'),  # Имя файла базы данных
    }
}
